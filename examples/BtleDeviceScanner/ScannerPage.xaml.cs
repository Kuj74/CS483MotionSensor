...
namespace MbientLab.BtleDeviceScanner {
    ...
    public sealed partial class ScannerPage : Page {
        ...
        private async void start_devices(object sender, RoutedEventArgs e)
        {
            ...
            // btleWatcher.Stop();
           // foreach (var paired in pairedDevices.SelectedItems)
            //{
                var item = pairedDevices.SelectedItem as BluetoothLEDevice;
